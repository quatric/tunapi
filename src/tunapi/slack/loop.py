...
async def _handle_file_command(
    ...
    async def _upload_file(filename: str, content: Any, _rel_path: str) -> bool:
...
async def _run_engine(
    ...
    await run_chat_engine(
        ...
        logger_obj=logger,
        resolve_cwd_log_event="slack.resolve_cwd_error",
        resolve_cwd_log_extra={},
        resolve_cwd_message=lambda exc: f"{exc}",
        runner_unavailable_log_event="slack.runner_unavailable",
        runner_unavailable_log_extra={},
        runner_unavailable_message=lambda issue: f"{issue}",
        dispatch_error_log_event="slack.dispatch_error",

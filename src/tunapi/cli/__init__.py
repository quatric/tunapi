...
def init(
    ...
    """Register the current repo as a Tunapi project."""
    run_init(
        alias=alias,
        default=default,
...
def create_app() -> typer.Typer:
    app = typer.Typer(
        ...
        help="Telegram bridge for coding agents. Docs: https://tunapi.dev/",
    )
    config_app = typer.Typer(help="Read and modify tunapi config.")
